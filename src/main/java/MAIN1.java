...
public class MAIN1
{
    public  static String readFileName = "D:\\IDEAHome\\WORK\\untitled1\\src\\main\\java\\doc\\BAMS数据转发通讯点表(A3)0.xlsx";
    ...
    public static void main(String[] args) throws Exception {
               /* OPCPackage opcPackage = POIXMLDocument.openPackage(readFileName);
                ...
                slaveStatus.setReadOrWrite("10101");slaveStatus.setSlaveId("10001");slaveStatus.setTerminalId("10102");
               FileUtils.outNewProto(toFilePath +"stack.proto", analogs,1,null,"Stack01",slaveStatus);
    }
